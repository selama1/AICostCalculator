...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 flex flex-col items-center max-w-7xl mx-auto">
      ...
      <header className="w-full mb-10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-300 px-4 py-2.5 rounded-full border border-slate-700 transition-all shadow-lg active:scale-95"
          >
      ...
      {/* Footer */}
      <footer className="w-full mt-20 pt-8 pb-12 border-t border-slate-800 flex flex-col items-center text-center gap-6">
        <div className="flex items-center gap-4 text-slate-500 text-sm">
          <span>&copy; {new Date().getFullYear()} Gemini Cost Estimator</span>
          <span className="w-1 h-1 rounded-full bg-slate-700"></span>
          <span>By <strong>Sela Mador-Haim</strong></span>
        </div>
        <div className="flex flex-wrap justify-center items-center gap-8">
          <a href="mailto:selama@gmail.com" className="group flex items-center gap-2 text-slate-400 hover:text-indigo-400 transition-all text-xs font-bold uppercase tracking-widest">
             <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
             selama@gmail.com
          </a>
          <a href="https://github.com/selama1" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-slate-400 hover:text-white transition-all text-xs font-bold uppercase tracking-widest">
          ...
          <a href="https://www.losttrackmusic.com/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-slate-400 hover:text-pink-400 transition-all text-xs font-bold uppercase tracking-widest">
      ...
      {showAboutModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/80 backdrop-blur-md" onClick={() => setShowAboutModal(false)} />
          <div className="relative bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl p-8 max-w-lg w-full animate-in zoom-in duration-300">
            <h2 className="text-3xl font-extrabold text-white mb-2">About This Tool</h2>
            <div className="space-y-4 text-slate-400 leading-relaxed mb-8">
              <p>
                The <strong>Gemini Cost Estimator</strong> is a professional utility designed to help developers and researchers understand the economic impact of their Gemini API calls. 
              </p>
              <p>
                It provides real-time token counts and cost breakdowns for text, audio, video, and image inputs across multiple model versions, including specialized "Thinking" modalities.
              </p>
              
              <div className="pt-4 border-t border-slate-800">
                <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-3">Created By</h3>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold">SM</div>
                    <div>
                      <div className="text-white font-bold">Sela Mador-Haim</div>
                      <div className="text-xs">Software Architect & AI Researcher</div>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-4 mt-2">
                    <a href="mailto:selama@gmail.com" className="text-xs text-indigo-400 hover:underline">selama@gmail.com</a>
                    <a href="https://github.com/selama1" target="_blank" rel="noopener noreferrer" className="text-xs text-indigo-400 hover:underline">github.com/selama1</a>
                    <a href="https://www.losttrackmusic.com/" target="_blank" rel="noopener noreferrer" className="text-xs text-indigo-400 hover:underline">losttrackmusic.com</a>
                  </div>
                </div>
              </div>
            </div>
